...
class Menu:
        ...
        def __init__(self, screen):
            ...
            self.back = button.Button(self.screen, resources.BUTTONS, resources.CUT_BACK, 582, 46)
            ...
            self.creditsTextLine7 = 'PEM - Projeto para Excelencia em Microeletronica.'
            self.font_30 = pygame.font.Font(resources.FONT, 30)
            self.font_20 = pygame.font.Font(resources.FONT, 20)
            self.creditsTextLine0Render = self.font_30.render(self.creditsTextLine0, 1, (0,0,0))
            self.creditsTextLine1Render = self.font_30.render(self.creditsTextLine1, 1, (0,0,0))
            self.creditsTextLine2Render = self.font_30.render(self.creditsTextLine2, 1, (0,0,0))
            self.creditsTextLine3Render = self.font_30.render(self.creditsTextLine3, 1, (0,0,0))
            self.creditsTextLine4Render = self.font_30.render(self.creditsTextLine4, 1, (0,0,0))
            self.creditsTextLine5Render = self.font_30.render(self.creditsTextLine5, 1, (0,0,0))
            self.creditsTextLine6Render = self.font_30.render(self.creditsTextLine6, 1, (0,0,0))
